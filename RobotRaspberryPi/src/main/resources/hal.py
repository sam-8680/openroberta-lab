...
class Hal(object):
    def __init__(self):
        ...
        self.leds[1] = {'o': RGBLED(3, 5, 7, pwm=True, active_high=False), 'c': (1, 1, 1), 'b': 1.}
        self.leds[2] = {'o': RGBLED(19, 21, 22, pwm=True, active_high=False), 'c': (1, 1, 1), 'b': 1.}
