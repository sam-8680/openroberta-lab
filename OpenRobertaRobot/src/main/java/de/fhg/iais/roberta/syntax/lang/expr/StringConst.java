...
public class StringConst<V> extends Expr<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        String field = AbstractJaxb2Ast.extractField(fields, BlocklyConstants.TEXT);
        return StringConst.make(field, AbstractJaxb2Ast.extractBlockProperties(block), AbstractJaxb2Ast.extractComment(block));
    }
